            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="${pageContext.request.contextPath}/admin/saveStudent" method="post" enctype="multipart/form-data">
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input pattern="dd-MM-yyyy" name="dob" type="date" class="form-control"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input pattern="dd-MM-yyyy" name="registerDate" type="date" class="form-control"/>
                                </div>
                                <div class="form-group col-md-6">
